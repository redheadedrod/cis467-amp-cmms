namespace CIS467_AMP.Migrations
{
    ...
    public partial class SeedShared2 : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("SET IDENTITY_INSERT ManufacturerPartTypes ON");
            Sql("INSERT INTO ManufacturerPartTypes (Id, Name) VALUES (0, 'Inner Seal')");
            Sql("INSERT INTO ManufacturerPartTypes (Id, Name) VALUES (1, 'Outer Seal')");
            Sql("INSERT INTO ManufacturerPartTypes (Id, Name) VALUES (2, 'Shaft')");
            Sql("SET IDENTITY_INSERT ManufacturerPartTypes OFF");
        }
